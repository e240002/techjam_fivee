...
const envSchema = z.object({
  ...
  CODEX_REASONING_EFFORT: z
    ...
    .optional(),
  CODEX_MODEL_VERBOSITY: z.enum(["low", "medium", "high"]).optional(),
...
export function loadConfig(environment: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    codexModelVerbosity: env.CODEX_MODEL_VERBOSITY,
...
export async function writeCodexConfig(config: AppConfig): Promise<void> {
  ...
  const toml = [
    ...
    ...(config.codexReasoningEffort
      ...
      : []),
    ...(config.codexModelVerbosity
      ? ["model_verbosity = " + JSON.stringify(config.codexModelVerbosity)]
      : []),
    "",
